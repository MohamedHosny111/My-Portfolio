...
import { Mail, ExternalLink, Globe, FileText, GraduationCap, Award, Phone, MessageSquare, Send, MapPin, Linkedin } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 font-sans px-6 py-12 md:px-20">
      {/* Header Section */}
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            ...
            <a href={`tel:${personalInfo.socialLinks.phone}`} className="px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg text-slate-200 transition text-sm flex items-center gap-2">
              <Phone className="w-4 h-4" /> {personalInfo.socialLinks.phone}
            </a>
            ...
            <div>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="bg-slate-950/60 border border-slate-800/60 p-4 rounded-xl">
                  ...
                  <span className="text-slate-200 text-sm font-medium mt-1 block">
